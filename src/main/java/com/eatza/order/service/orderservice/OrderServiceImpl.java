...
import com.eatza.order.config.KafkaConfiguration;
...
import com.eatza.order.service.itemservice.RestaurantFeignClient;
...
public class OrderServiceImpl implements OrderService {
	...
	public Order placeOrder(OrderRequestDto orderRequest) throws OrderException {
		...
		kafkaTemplate.send(TOPIC, savedOrder.getId());
		return savedOrder;
	}
